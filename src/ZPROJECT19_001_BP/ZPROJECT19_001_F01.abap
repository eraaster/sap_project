...
FORM CONTAINER2_FIELD .
  ...
  GS_FIELDCAT-SCRTEXT_M = '구매처명'.
  APPEND GS_FIELDCAT TO GT_FIELDCAT1.

  CLEAR : GS_FIELDCAT.
  GS_FIELDCAT-COL_POS = 3.
  GS_FIELDCAT-FIELDNAME = 'LAND1'.
  GS_FIELDCAT-SCRTEXT_M = '국가키'.
  APPEND GS_FIELDCAT TO GT_FIELDCAT1.
...
FORM CONTAINER3_FIELD .
  ...
  GS_FIELDCAT-SCRTEXT_M = '삭제지시자'.
  APPEND GS_FIELDCAT TO GT_FIELDCAT2.

  CLEAR : GS_FIELDCAT.
  GS_FIELDCAT-COL_POS = 4.
  GS_FIELDCAT-FIELDNAME = 'ZAKONT'.
  GS_FIELDCAT-SCRTEXT_M = '계정'.
  APPEND GS_FIELDCAT TO GT_FIELDCAT2.

  CLEAR : GS_FIELDCAT.
  GS_FIELDCAT-COL_POS = 5.
  GS_FIELDCAT-FIELDNAME = 'ZTERM'.
  GS_FIELDCAT-SCRTEXT_M = '지급조건'.
  APPEND GS_FIELDCAT TO GT_FIELDCAT2.
ENDFORM.
*&---------------------------------------------------------------------*
...
FORM ALV_LAYOUT2 .
  ...
  IF p_ktokk = '3000'. "개인번호
    IF <fs>-FIELDNAME = 'STCD2'. "사업자번호
      <fs>-NO_OUT = 'X'.
    ELSEIF <fs>-FIELDNAME = 'STRAS'. "주소
      <fs>-NO_OUT = 'X'.
    ENDIF.
  ELSEIF p_ktokk = '2000'. "해외번호
    IF <fs>-FIELDNAME = 'STCD1'. "개인번호
      <fs>-NO_OUT = 'X'.
    ELSEIF <fs>-FIELDNAME = 'STCD2'. "사업자번호
      <fs>-NO_OUT = 'X'.
    ENDIF.
  ENDIF.
  ENDLOOP.
...
FORM change_data .
  ...
  MESSAGE '구매처 데이터가 성공적으로 변경되었습니다.' TYPE 'S'.
